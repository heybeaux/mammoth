  ...
  async proposeClaims(request: {
    ...
    const outcome = await this.#complete(
      ...
      [
        ...
        'A statement must restate only what that quote directly says: never mix',
        ...
        'directly answer, and include at least two material words from each mapped',
        'subquestion in the statement. Prefer coverage across distinct source',
